...
API_KEY = "QrDluCnEm5wozju2bgmjefHBytTHjWqOlbg8aNKGLx83"
...
def login():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/cce89baa-31c3-403a-8913-2133626491ab/predictions?version=2022-11-19', json=payload_scoring,
